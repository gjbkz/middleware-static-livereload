...
if (userName && accessKey) {
    const list: Array<[ICapability, Partial<IBrowsetStackOptions>]> = [
        ...
        [{browserName: 'Chrome'}, {os: 'OS X', osVersion: 'Mojave'}],
        [{browserName: 'Firefox'}, {os: 'OS X', osVersion: 'Mojave'}],
        [{browserName: 'Safari'}, {os: 'OS X', osVersion: 'Mojave'}],
        [{browserName: 'Safari'}, {osVersion: '12', deviceName: 'iPhone 8', realMobile: 'true'}],
