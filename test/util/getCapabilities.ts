...
export const getBrowserStackCapabilities = (
    ...
    for (const name of names) {
        ...
        capabilities.push(mergeCapability({...commonOptions, osVersion: '13', deviceName: 'iPhone 8', realMobile: 'true'}, {browserName: 'Safari'}));
        capabilities.push(mergeCapability({...commonOptions, osVersion: '10.0', deviceName: 'Google Pixel 3', realMobile: 'true'}, {browserName: 'Chrome'}));
